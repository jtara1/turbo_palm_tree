...
from turbo_palm_tree.turbo_palm_tree.utility.parse_arguments \
    import parse_arguments
from turbo_palm_tree.turbo_palm_tree.utility.get_subreddit_submissions \
    import GetSubredditSubmissions
from turbo_palm_tree.turbo_palm_tree.utility.download_subreddit_submissions \
    import DownloadSubredditSubmissions
from turbo_palm_tree.turbo_palm_tree.utility.parse_subreddit_list \
    import parse_subreddit_list
from turbo_palm_tree.turbo_palm_tree.utility.general_utility \
...
def main():
    ...
    for subreddit, path in subreddit_list:
        ...
        download_submissions(
            ...
            previous_id=args.prev_id, disable_db=args.disable_database,
            disable_im=args.disable_image_match,
            debug=args.debug)
